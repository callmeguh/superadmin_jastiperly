            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between">
                        ...
                        <span class="fw-bold">{{ number_format($completedTransactions) }}</span>
                    </div>
                    <div class="progress h-6-px">
                        <div class="progress-bar bg-success" style="width: {{ $completedTransactions ? ($completedTransactions / max(1, $totalUsers)) * 100 : 0 }}%"></div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between">
                        ...
                        <span class="fw-bold">{{ number_format($ongoingTransactions) }}</span>
                    </div>
                    <div class="progress h-6-px">
                        <div class="progress-bar bg-warning" style="width: {{ $ongoingTransactions ? ($ongoingTransactions / max(1, $totalUsers)) * 100 : 0 }}%"></div>
                    </div>
                </div>
...
document.addEventListener("DOMContentLoaded", function () {
    var options = {
        ...
        series: [{
            name: 'Pengguna Baru',
            data: @json(array_values($usersByMonth->toArray())) // ambil jumlah user per bulan
        }],
        xaxis: {
