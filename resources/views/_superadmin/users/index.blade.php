    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $role == 'penitip' ? 'active' : '' }}" 
                       href="{{ route('superadmin.users.index', ['role' => 'penitip']) }}">
                        Penitip
                    </a>
                </li>
                <li class="nav-item">
                    ...
                    @forelse($users as $user)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{ route('superadmin.users.edit', $user) }}" class="btn btn-sm btn-primary" title="Edit">
                                    <iconify-icon icon="mdi:pencil"></iconify-icon>
                                </a>
                                <form action="{{ route('superadmin.users.destroy', $user) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus pengguna ini?');">
                                    @csrf
                                    @method('DELETE')
